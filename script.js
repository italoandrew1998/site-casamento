...
const gifts = [
  ...
  { id: 14, image: "jogo de cama.jpg", title: "Jogo de cama", category: "Casa, tamanho queen", url: "https://shopee.com.br/product/514474285/22397280584", store: "Shopee", price: "Sugestao", acceptsQuota: true }, 
...
function prepareRsvp(event) {
  ...
  if (answer === "sim") {
    ...
    text = `Voce esta avisando que<br><b style="font-size:22px;color:#d9534f;">${esc(name)}</b><br>nao podera comparecer.`; 
  }
...
function renderGuestAdmin() {
  ...
  if (byId("confirmedCount")) byId("confirmedCount").textContent = confirmedCount;
  if (byId("declinedCount")) byId("declinedCount").textContent = declinedCount;
